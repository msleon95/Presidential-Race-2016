# delaware_elections.py
# Author: Laura Leon
# modified on Dec 4,2018
# Purpose: Program to demonstrate how to input a Delaware county and
...
# Open file delaware_counties.txt
delaware= open("delaware_counties.txt")

# Read the header
header= delaware.readline()
...
county = input("Enter a Delaware county:")
